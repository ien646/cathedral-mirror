...
- `CATHEDRAL_APP_EDITOR2_INITIAL_PROJECT_DIR` -> setting this option to an existing project directory will open it automatically when running a dev build of the editor