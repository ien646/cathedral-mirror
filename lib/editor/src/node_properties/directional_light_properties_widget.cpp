...
namespace cathedral::editor
{
    ...
    directional_light_properties_widget::directional_light_properties_widget(
        project::project* pro,
        engine::scene& scene,
        QWidget* parent,
        engine::directional_light_node* node)
        : node_properties_widget(pro, parent, node, false)
        , _node(node)
    {
        ...
        connect(intensity, &sliding_float::value_changed, this, [this](const float value) { _node->set_intensity(value); });
