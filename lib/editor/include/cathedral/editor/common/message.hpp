...
namespace cathedral::editor
{
    ...
    void show_warning_message(const QString& msg, QWidget* parent = nullptr);
    ...
    void show_warning_message(const std::string& msg, QWidget* parent = nullptr);
    ...
    void show_warning_message(const char* msg, QWidget* parent = nullptr);
