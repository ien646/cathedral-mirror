...
namespace cathedral::editor
{
    ...
    {
        auto msgbox = QMessageBox(QMessageBox::Icon::Information, "Error", msg, QMessageBox::StandardButton::Ok, parent);
        msgbox.exec();
    }

    void show_warning_message(const QString& msg, QWidget* parent)
    {
        auto msgbox = QMessageBox(QMessageBox::Icon::Warning, "Error", msg, QMessageBox::StandardButton::Ok, parent);
        msgbox.exec();
    }

    void show_error_message(const QString& msg, QWidget* parent)
    {
        auto msgbox = QMessageBox(QMessageBox::Icon::Critical, "Error", msg, QMessageBox::StandardButton::Ok, parent);
        msgbox.exec();
    }
    ...
    void show_warning_message(const std::string& msg, QWidget* parent)
    {
        show_warning_message(QString::fromStdString(msg), parent);
    }
    ...
    void show_warning_message(const char* msg, QWidget* parent)
    {
        show_warning_message(QString{ msg }, parent);
    }
