if(WIN32)
    ...
    if(${CMAKE_BUILD_TYPE} STREQUAL "Debug")
        ...
        find_library(LIB_SPIRV_CROSS_CORE NAME "spirv-cross-cored" HINTS ${LIB_PATH_HINTS} REQUIRED)
        find_library(LIB_SPIRV_CROSS_CPP NAME "spirv-cross-cppd" HINTS ${LIB_PATH_HINTS} REQUIRED)
        find_library(LIB_SPIRV_CROSS_GLSL NAME "spirv-cross-glsld" HINTS ${LIB_PATH_HINTS} REQUIRED)
        find_library(LIB_SPIRV_CROSS_REFLECT NAME "spirv-cross-reflectd" HINTS ${LIB_PATH_HINTS} REQUIRED)
        find_library(LIB_SHADERC_COMBINED NAME "shaderc_combinedd" HINTS ${LIB_PATH_HINTS} REQUIRED) 
    else()
        ...
        find_library(LIB_SHADERC_COMBINED NAME "shaderc_combined" HINTS ${LIB_PATH_HINTS} REQUIRED) 
    endif()
else()
