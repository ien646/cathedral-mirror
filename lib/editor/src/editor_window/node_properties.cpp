...
namespace cathedral::editor
{
    namespace
    {
        ...
        void draw_mesh3d_properties(engine::mesh3d_node* node)
        {
            ...
            ImGui::BeginGroup();
            {
                ...
                {
                    ImGui::TextColored(colors::BG_WARNING_YELLOW, "No mesh selected");
                    ImGui::SameLine();
                ...
                {
                    ImGui::Text("%s", node->mesh_name().value().c_str());
                    ImGui::SameLine();
                    if (ImGui::Button("Select"))
                    {
                    }
    ...
    void node_properties::tick(const unordered_set<engine::scene_node*>& nodes)
    {
        ImGui::Begin(WINDOW_ID);
        {
            ...
            else
            {
                ...
                {
                    draw_mesh3d_properties(nodeptr);
                }
            }
        }
        ImGui::End();
