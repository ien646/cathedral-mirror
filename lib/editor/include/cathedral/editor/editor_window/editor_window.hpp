...
#include <cathedral/editor/dialogs/scene_selector_dialog.hpp>
...
#include <cathedral/editor/editor_window/scene_tree.hpp>
#include <cathedral/editor/editor_window/stats_panel.hpp>
...
namespace cathedral::editor
{
    ...
    private:
        ...
        std::unique_ptr<texture_manager> _texture_manager;
